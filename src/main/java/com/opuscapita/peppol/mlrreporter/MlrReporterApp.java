package com.opuscapita.peppol.mlrreporter;
...
@ComponentScan({"com.opuscapita.peppol.mlrreporter", "com.opuscapita.peppol.commons"})
public class MlrReporterApp {
    ...
    @Autowired
    public MlrReporterApp(ContainerMessageConsumer consumer) {
        this.consumer = consumer;
    }

    public static void main(String[] args) {
        SpringApplication.run(MlrReporterApp.class, args);
    }
